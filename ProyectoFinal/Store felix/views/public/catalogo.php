                ...
                <div class="card h-100 shadow-sm">
                    <?php if (!empty($producto['imagen'])): ?>
                        <div class="text-center mt-3">
                            <img src="views/img/<?= htmlspecialchars($producto['imagen']); ?> "class="img-fluid rounded" 
                            style=" width: 180px; height: 180px; object-fit: cover;">
                        </div>
                        <?php else: ?>
                            <div class="text-center mt-3">
                                <img src="https://via.placeholder.com/180x180?text=Sin+Imagen" class="img-fluid rounded">
                            </div>
                            <?php endif; ?>
                    <div class="card-body">
